...
<section id="flexbox-section">
    ...
    <div class="container">
        ...
        <p>
            Our framework uses a flexible grid system with rows and columns. Columns automatically share available space
            unless you specify sizes.
        </p>

        <ul class="list-style-none">
            <li><code class="text-primary">.row</code>: Defines a flex container for columns.</li>
            <li><code class="text-primary">.col</code>: A flexible column that shares equal width with siblings.</li>
            <li><code class="text-primary">.col-[number]</code>: Column with a fixed portion of the row (out of 12 parts). The number can range up to 12.</li>
            <li><code class="text-primary">.col-[size]-[number]</code>: Responsive columns that apply from the specified breakpoint upwards. Sizes include <code>sm</code>, <code>md</code>, <code>lg</code>, and <code>xl</code>.</li>
            <li><code class="text-primary">.row-cols-[number]</code>: Defines how many equal-width columns fit in a row at all viewport sizes. The number can range up to 6.</li>
            <li><code class="text-primary">.row-cols-[size]-[number]</code>: Responsive variants that apply column counts from the specified breakpoint upwards. Sizes include <code>sm</code>, <code>md</code>, <code>lg</code>, and <code>xl</code>.</li>
        </ul>
