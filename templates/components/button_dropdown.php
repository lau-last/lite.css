    ...
    <div class="container">
        ...
        <div data-code-target="#code-dropdown-button">
            <div class="dropdown-button-wrapper">
                ...
                <!--Button-->
                <button type="button"
                        class="dropdown-btn btn-primary w-100 d-flex justify-content-between mt-half"
                ...
                <!--Content-->
                <div id="dropdown1" class="dropdown-content-push">
                    <p class="p-1">
            ...
            <div class="dropdown-button-wrapper">
                ...
                <!--Content-->
                <div id="dropdown2" class="dropdown-content-push">
                    <p class="p-1">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur cumque distinctio, dolorum
                        eligendi excepturi hic, modi natus non nostrum obcaecati repellat sint tenetur ut. Accusamus
                        aspernatur autem cum delectus deleniti dolor, facilis fugit illo ipsa ipsum laboriosam, laborum
            ...
            <div class="dropdown-button-wrapper">
                ...
                <!--Content-->
                <div id="dropdown3" class="dropdown-content-push">
                    <p class="p-1">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur cumque distinctio, dolorum
                        eligendi excepturi hic, modi natus non nostrum obcaecati repellat sint tenetur ut. Accusamus
                        aspernatur autem cum delectus deleniti dolor, facilis fugit illo ipsa ipsum laboriosam, laborum
            ...
            <div class="dropdown-button-wrapper">
                ...
                <!--Content-->
                <div id="dropdown4" class="dropdown-content-push">
                    <p class="p-1">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur cumque distinctio, dolorum
                        eligendi excepturi hic, modi natus non nostrum obcaecati repellat sint tenetur ut. Accusamus
                        aspernatur autem cum delectus deleniti dolor, facilis fugit illo ipsa ipsum laboriosam, laborum
