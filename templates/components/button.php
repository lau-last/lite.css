<section id="button">
    ...
    <div class="d-flex align-items-center">
        <h3>Button pill</h3>
        <div class="ms-2 cursor-pointer" data-action="toggle-display" data-target="#container-code-button-pill"></div>
    </div>

    <div data-code-target="#code-button-pill">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container-code mt-2 d-none" id="container-code-button-pill">
        <button class="btn-primary position-top-right" type="button" data-position-tooltip="left" data-action="copy"
                data-target="#code-button-pill" data-tooltip="Copié !">Copier
        </button>
        <pre><code id="code-button-pill" data-type="code">
        </code></pre>
    </div>
    ...
    <div class="d-flex align-items-center mt-2">
        <h3>Button small</h3>
        <div class="ms-2 cursor-pointer" data-action="toggle-display" data-target="#container-code-button-small"></div>
    </div>

    <div data-code-target="#code-button-small">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container-code mt-2 d-none" id="container-code-button-small">
        <button class="btn-primary position-top-right" type="button" data-position-tooltip="left" data-action="copy"
                data-target="#code-button-small" data-tooltip="Copié !">Copier
        </button>
        <pre><code id="code-button-small" data-type="code">
        </code></pre>
    </div>
    ...
    <div class="d-flex align-items-center mt-2">
        <h3>Button medium</h3>
        <div class="ms-2 cursor-pointer" data-action="toggle-display" data-target="#container-code-button-medium"></div>
    </div>

    <div data-code-target="#code-button-medium">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container-code mt-2 d-none" id="container-code-button-medium">
        <button class="btn-primary position-top-right" type="button" data-position-tooltip="left" data-action="copy"
                data-target="#code-button-medium" data-tooltip="Copié !">Copier
        </button>
        <pre><code id="code-button-medium" data-type="code">
        </code></pre>
    </div>
    ...
    <div class="d-flex align-items-center mt-2">
        <h3>Button large</h3>
        <div class="ms-2 cursor-pointer" data-action="toggle-display" data-target="#container-code-button-large"></div>
    </div>

    <div data-code-target="#code-button-large">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container-code mt-2 d-none" id="container-code-button-large">
        <button class="btn-primary position-top-right" type="button" data-position-tooltip="left" data-action="copy"
                data-target="#code-button-large" data-tooltip="Copié !">Copier
        </button>
        <pre><code id="code-button-large" data-type="code">
        </code></pre>
    </div>
    ...
    <div class="d-flex align-items-center mt-2">
        ...
        <div class="ms-2 cursor-pointer" data-action="toggle-display" data-target="#container-code-button-outline"></div>
    </div>

    <div data-code-target="#code-button-outline">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container-code mt-2 d-none" id="container-code-button-outline">
        <button class="btn-primary position-top-right" type="button" data-position-tooltip="left" data-action="copy"
                data-target="#code-button-outline" data-tooltip="Copié !">Copier
        </button>
        <pre><code id="code-button-outline" data-type="code">
        </code></pre>
    </div>
